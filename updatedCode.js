...
document
  ...
  .addEventListener("click", (event) => {
    ...
    if (!hasDrones) {
      ...
      dashboard.style.minHeight = "100vh"; // Ensure parent takes full viewport height
      dashboard.style.position = "relative";
    } else {
      // Hide the message if drones are present
